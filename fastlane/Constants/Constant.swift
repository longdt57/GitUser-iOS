...
enum Constant {
    ...
    static let keychainName = "GitUser_keychain"
    ...
    static let stagingBundleId = "leegroup.app.gituser.staging"
    static let productionBundleId = "leegroup.app.gituser"
    static let projectName = "GitUser"
